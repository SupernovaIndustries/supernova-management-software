...
<head>
    ...
    <title>Monitoraggio Import Componenti</title>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
                <div class="flex items-center mb-6">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900">📦 Monitoraggio Import Componenti</h1>
                </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-blue-800">
                                <strong>Job ID:</strong> <code class="bg-blue-100 px-2 py-1 rounded"><?php echo e($jobId); ?></code>
                            </p>
                ...
                <script>
                    ...
                    // Update progress bar
                    setInterval(() => {
                        fetch('/api/import-progress/<?php echo e($jobId); ?>')
                            .then(r => r.json())
                            .then(data => {
                                if (data) {
                    ...
                    // Update logs
                    setInterval(() => {
                        fetch('/api/import-logs/<?php echo e($jobId); ?>')
                            .then(r => r.json())
                            .then(data => {
...
<?php /**PATH /Users/supernova/supernova-management/resources/views/import-progress.blade.php ENDPATH**/ ?>